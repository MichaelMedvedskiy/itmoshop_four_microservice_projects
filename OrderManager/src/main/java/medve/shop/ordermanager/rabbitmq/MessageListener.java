package medve.shop.ordermanager.rabbitmq;

import medve.shop.ordermanager.enums.ApplicationConstant;
...
public class MessageListener {
     ...
     * @param data a payment-defined object used for deserialization of message
     */
    @RabbitListener(queues = "${app1.queue.name}")
    public void receiveMessageForApp1(final Order data) {
